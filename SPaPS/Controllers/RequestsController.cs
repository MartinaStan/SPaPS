...
namespace SPaPS.Controllers
{
    ...
    public class RequestsController : Controller
    {
        ...
        public RequestsController(SPaPSContext context, IEmailSenderEnhance emailService, UserManager<IdentityUser> userManager) //RoleManager<IdentityRole> roleManager)
        {
            _context = context;
